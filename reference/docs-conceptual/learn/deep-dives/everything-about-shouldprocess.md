...
that is hard to mock in pester, I can often wrap it in `ShoudProcess` and call it with `-WhatIf` in
...
This actually works correctly most of the time. Anytime you call builtin Cmdlet or a function in
